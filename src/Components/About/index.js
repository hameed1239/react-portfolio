...
function About(props) {
    ...
    return (
        <div className="about">
            ...
            <p className="story m-1-5em align-left">When I'm not writting code or solving a problem, you would find me playing FIFA on PS5, cooking or watching movies with my family. I also love traveling and seeing new places. As a full-stack engineer, I enjoy turning complex problems into simple user friendly applications.<span className="link" onClick={() => { setCurrentPage(pages[1]) }}>See my work</span> </p>
